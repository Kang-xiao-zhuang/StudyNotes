...
[官方文档https://docs.spring.io/spring-framework/docs/current/reference/html/](https://docs.spring.io/spring-framework/docs/current/reference/html/)
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="hello" class="com.zhuang.pojo.Hello">
...
```xml
<bean id="user" class="com.hou.zhuang.User">
...
```xml
<bean id="user" class="com.zhuang.pojo.User">
...
```xml
<bean id="use2" class="com.pojo.User" c:name="kun" c:age="19"
scope="singleton"/>
```
...
使用**@Autowire**我们可以不用编写set方法了，前提是你这个自动装配的属性在IOC(spring)容器中存在，且符合名字byname
...
- @autowire默认通过byname实现，而且必须要求这个对象存在
