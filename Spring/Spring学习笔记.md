...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="userdaomysql" class="com.hou.zhuang.UserDaoMysqlImpl"></bean>

    <bean id="userServiceImpl" class="com.zhuang.service.UserServiceImp">
...
```xml
<bean id="user" class="com.zhuang.pojo.User">
    <constructor-arg name="name" value="zhuang"></constructor-arg>
</bean>
